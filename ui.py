...
ui_app = Starlette(
    ...
    routes=[
        ...
        Route("/ui/api/errors/ack", system.errors_ack, methods=["POST"]),
        ...
        Route("/ui/api/mapping/graphs", mapping.mapping_graphs),
        Route("/ui/api/mapping/graphs", mapping.mapping_graph_action, methods=["POST"]),
